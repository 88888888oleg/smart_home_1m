...
class BigOffButton extends StatefulWidget {
  BigOffButton({Key? key,
  ...
  @override
  _BigOffButtonState createState() => _BigOffButtonState();
}

class _BigOffButtonState extends State<BigOffButton> {
